            ...
            <div className="row">
                {locations.map((location) =>
                    location.properties.map((property) => (
                        <div className="col-md-4 mb-4" key={`${location.name}-${property.id}`}>
                            <div className="card bg-dark text-white h-100 shadow-sm">
                                ...
                                <div className="card-body d-flex flex-column">
                                    ...
                                    <p className="card-text text-muted mb-1"><strong>Location:</strong> {location.name}</p>
                                    <p className="card-text mb-1"><strong>Address:</strong> {property.address}</p>
                                    <p className="card-text mb-1"><strong>Price:</strong> {property.price}</p>
                                    <p className="card-text mb-1"><strong>Size:</strong> {property.size}</p>
                                    <p className="card-text mb-1"><strong>Type:</strong> {property.type}</p>
                                    <p className="card-text mb-2"><strong>Furnished:</strong> {property.furnished}</p>
